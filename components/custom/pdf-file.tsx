          ...
          <View style={styles.table}>
            ...
            <View style={styles.rowSignee}>
              <View style={[styles.cellSignee, { borderRightWidth: 1 }]}>
                <Image src={user?.user?.signature as string} style={styles.signature} />
            ...
            <View style={styles.rowSignee}>
              <View style={[styles.cellSignee, { borderRightWidth: 1 }]}>
                <Image
                  src={
                    "https://files.edgestore.dev/k9ws45fyad55utql/myPublicImages/_public/ADMIN/1abc7132-e241-4e69-826d-f87d719355d0.png"
                  }
